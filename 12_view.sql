...
-- 장점: view 는 데이터를 쉽게 읽고 이해할 수 있도록 돕는 동시에, 
...
insert into tbl_menu values(null, '식혜맛국밥', 5500, 4, 'Y');		-- 추가됨 / 베이스테이블_원본, 가상의공간 모두 변경됨. (베이스테이블 가서 변경)
insert into hansik values(null, '수정과국밥', 6000, 4, 'Y');		-- 추가됨 / 베이스테이블_원본, 가상의공간 모두 변경됨. (가상의 공간에서 변경)
